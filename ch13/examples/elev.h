...
#include "borlaCon.h" // for console graphics
#include <iostream>
#include <iomanip> // for setw()
#include <stdio.h> // replacement for <conio.h>
//#include <conio.h> // for screen output
#include <stdlib.h> // for itoa(), exit()
...
class elevator
{
 private:
  ...
  bool destination[NUM_FLOORS]; // selected by occupantsint loading_timer; 
 ...
 public:
  ...
  direction get_direction() const; //get current directino
};
//////////////////////////////////////////////////////////
class building
{
 private:
  ...
  int num_cars; // cars reated so far
  //array o up/down buttons
 ...
 public:
  ...
  direction get_cars_dir(const int) const; // find which way a car is going
  bool get_floor_req(const int, const int) const; // set specific floor req
